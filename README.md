# PackLight — Landing Page

Static landing page for the PackLight backpacking trip planner apps.

**Live site:** https://sbrines.github.io/PackLight-Web *(after GitHub Pages is enabled)*
...
- [ ] Update the `og:url` to the real domain if you set one up (e.g. `packlight.app`)
